...
public class CustomArrayAdapter extends ArrayAdapter<ListItemClass> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            viewHolder.data1 = convertView.findViewById(R.id.dvData1);
            viewHolder.data2 = convertView.findViewById(R.id.dvData2);
            viewHolder.data3 = convertView.findViewById(R.id.dvData3);
            viewHolder.data4 = convertView.findViewById(R.id.dvData4);
